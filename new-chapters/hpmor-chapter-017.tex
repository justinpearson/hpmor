...
\label{ch-LocatingtheHypothesis}
...
Dumbledore was laughing now.\hint{Dumbledore is laughing because he realizes that Voldemort has created a good Voldemort (Harry) to oppose the evil one (Tom Riddle), see page~\pageref{dd-laughs2}}
\mylabel{dd-laughs}
